...
// Core visible interaction surfaces that the runtime queries by class must remain present.
...
// Current gameplay shell is local-first and must not grow hidden third-party runtime dependencies.
...
// Responsive/mobile and reduced-motion behavior are release contracts, not optional decoration.
...
// Canonical canvas coordinate system must stay aligned with pointer mapping.
