...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        // The approved PartyTeller artwork already contains its own status/navigation chrome,
        // so render the app edge-to-edge instead of stacking Android bars on top of it.
